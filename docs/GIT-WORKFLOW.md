...
## 4. Выполните обязательный Pull Request
...
## 5. Рекомендуемая работа вдвоём

| Участник | Задача | Ветка |
| --- | --- | --- |
| Первый | Проверка ручного ввода и интерфейса | `feature/input-review` |
| Второй | Проверка перемещения и Pull Request | `feature/move-shapes` |
...
## 6. История, подготовленная в проекте
